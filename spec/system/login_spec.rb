...
RSpec.describe 'LoginPage', type: :system do
  before :all do
    @user1 = User.create!(id: 1, full_name: 'Babi',
                          email: 'b@g.com', password: '123456',
                          created_at: '2022-06-15 06:29:35.011315')

    @user2 = User.create!(id: 2, full_name: 'Jhon',
                          email: 'a@g.com', password: '123456',
                          created_at: '2022-06-15 06:29:35.011315')

    @user3 = User.create!(id: 3, full_name: 'Alemayehu',
  ...
  context 'testing' do
    ...
    it 'Log in should render correctly' do
